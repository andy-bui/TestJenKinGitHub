...
class BikokusaiSettingDataSource: BaseDataSource {
    override func initialData() -> [BaseDataSourceSection] {
        ...
        let bikokusaiProductsCell = SingleItemCellModel(withTitle: "購入セット", accessoryType: .disclosureIndicator, nibName: AppConfig.Nibs.singleItemContentCell, cellAction: BikokusaiSettingsAction.selectBikokusaiProduct)
        ...
        let startingDayCell = SingleItemCellModel(withTitle: "購入日付", accessoryType: .disclosureIndicator, nibName: AppConfig.Nibs.singleItemContentCell, cellAction: BikokusaiSettingsAction.startingDay)
